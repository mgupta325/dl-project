...
def get_text(img):
    ...
    if cgt_text_20_score == cgt_text_100_score and x == y:
        return cgt_text_20
        
    # text_list, score_list = [cgt_text_20, cgt_text_100, pdf_text, island_text], [cgt_text_20_score,cgt_text_100_score,pdf_text_score,island_text_score]
